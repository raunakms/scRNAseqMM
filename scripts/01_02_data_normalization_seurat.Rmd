...
# Load Sparse Matrix ---
sp.mat <- myRead10X(dir.data, sampleid="0661-2_CD138Minus")

# Initialize the Seurat object with the raw (non-normalized data) ---
mm.obj <- CreateSeuratObject(counts = sp.mat, 
                             min.cells = 3,
                             min.features = 100, 
                             project = "0661-2_CD138Minus")
```
...
#### WRITE OUTPUT 
```{r}
#file.expr <- file.path(dir.output, "normalized_expr_0661-2_CD138Minus.tsv")
...
#### Cluster cells
```{r}
mm.obj <- FindNeighbors(mm.obj, dims = 1:5)
...
```{r}
mm.obj <- RunTSNE(object = mm.obj, dims.use = 1:5)
```
...
DimPlot(object = mm.obj, pt.size = 3, cols=jColFun(14))
```
